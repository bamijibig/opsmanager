    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ManyToManyField(related_name='modules', to='auth.group')),
            ],
        ),
        migrations.CreateModel(
            name='Permission',
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='account_permission_set', to='contenttypes.contenttype')),
            ],
        ),
        migrations.CreateModel(
            name='RegisterUser',
